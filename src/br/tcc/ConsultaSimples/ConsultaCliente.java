...
public class ConsultaCliente extends javax.swing.JFrame {
    ...
    public String retornaDsCliente="";
    ...
    private void jTConsultaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTConsultaMouseClicked
        ...
        retornaDsCliente = jTConsulta.getValueAt(linha, 1).toString();
    ...
    private void jBPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBPesquisarActionPerformed
        ...
        switch (jCbPesquisa2.getSelectedIndex()) {
            case 0: {
                clienteDAO.consultasimples(cliente);
                preencher.PreencherJtableGenerico(jTConsulta, cliente.getRetorno());
                return;
            }
            case 1: {
                String DsCliente = jTFPesquisa.getText().toUpperCase();
                clienteDAO.consultaDescSimples(DsCliente, cliente);
                preencher.PreencherJtableGenerico(jTConsulta, cliente.getRetorno());
                return;
            }
        }
