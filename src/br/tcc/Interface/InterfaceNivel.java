 ...
 * @author JOÃO PAULO
 */
public class InterfaceNivel extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTFIdNivel = new javax.swing.JTextField();
        jLabel2 = new javax.swing.JLabel();
        jTFdsNivel = new javax.swing.JTextField();
        ...
        jPCadastroLayout.setHorizontalGroup(
            ...
            .addGroup(jPCadastroLayout.createSequentialGroup()
                ...
                .addGroup(jPCadastroLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jTFIdNivel, javax.swing.GroupLayout.PREFERRED_SIZE, 131, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel2)
                    .addComponent(jTFdsNivel, javax.swing.GroupLayout.PREFERRED_SIZE, 362, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPCadastroLayout.setVerticalGroup(
            ...
            .addGroup(jPCadastroLayout.createSequentialGroup()
                ...
                .addComponent(jLabel1)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jTFIdNivel, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addComponent(jLabel2)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(jTFdsNivel, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
        ...
        jCbPesquisa2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Geral", "Nivel" }));
    ...
    private void jBtIncluir1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtIncluir1ActionPerformed
        ...
        jTFdsNivel.grabFocus();
        lcampos.LimparCampos(jPCadastro);
        situacao = 1;
        estadobotoes(true);
        jTFIdNivel.setEnabled(false);         
    ...
    private void jBtGravarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtGravarActionPerformed
        ...
        if(situacao == 1) {
            ...
            if(jTFdsNivel.getText().equals("")){
                JOptionPane.showMessageDialog(null, "Informe o nivel");
                jTFdsNivel.grabFocus();
                return;
            } else{
                nivel.setDSNIVEL(jTFdsNivel.getText().toUpperCase());
                nivelDAO.incluir(nivel);
                lcampos.LimparCampos(jPCadastro);
                estadobotoes(false);
            }
            ...
            if(jTFdsNivel.getText().equals("")){
                ...
                nivel.setDSNIVEL(jTFdsNivel.getText());
    ...
    private void jBPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBPesquisarActionPerformed
        ...
        switch (jCbPesquisa2.getSelectedIndex()) {
            case 0: {
                nivelDAO.consulta(nivel);
                preencher.PreencherJtableGenerico(jTbPesquisa, nivel.getRetorno());
                return;
            }
            case 1: {
                nivel.setDSNIVEL(jTFPesquisa.getText().toUpperCase());
                nivelDAO.consultadescricao(nivel);
                preencher.PreencherJtableGenerico(jTbPesquisa, nivel.getRetorno());
                return;
            }
    }                       
    ...
    private void jTbPesquisaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTbPesquisaMouseClicked
         ...
         if (evt.getClickCount() == 1) {
            ...
            nivel.setIDNIVEL(Integer.parseInt(ID));
            nivelDAO.retornadados(nivel);  
            
            jTFIdNivel.setText(Integer.toString(nivel.getIDNIVEL()));
            jTFdsNivel.setText(nivel.getDSNIVEL());
        }
        estadobotoes(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InterfaceNivel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InterfaceNivel().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField jTFIdNivel;
    private javax.swing.JTextField jTFPesquisa;
    private javax.swing.JTextField jTFdsNivel;
