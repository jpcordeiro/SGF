 ...
 * @author JOÃO PAULO
 */
public class ConsultaFamilia extends javax.swing.JFrame {
    
    Familia familia = new Familia();
    FamiliaDAO familiaDAO = new FamiliaDAO();
    public String retornaId ="";
    public String retornaDsFamilia="";
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(
            ...
            .addComponent(jTPFamilia, javax.swing.GroupLayout.DEFAULT_SIZE, 407, Short.MAX_VALUE)
        );
    ...
    private void jTConsultaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTConsultaMouseClicked
        ...
        retornaDsFamilia = jTConsulta.getValueAt(linha, 1).toString();
    ...
    private void jBPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBPesquisarActionPerformed
        ...
        switch (jCbPesquisa2.getSelectedIndex()) {
            case 0: {
                ...
                preencher.PreencherJtableGenerico(jTConsulta, familia.getRetorno());
                return;
            }
            case 1: {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConsultaFamilia().setVisible(true);
            }
        });
    }
