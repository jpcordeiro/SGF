 ...
 * @author JOÃO PAULO
 */
public class ConsultaTpMovto extends javax.swing.JFrame {
    
    TipoMovto tipoMovto = new TipoMovto();
    TpMovtoDAO tpMovtoDAO = new TpMovtoDAO();
    public String retornaId ="";
    public String retornaDsTpMovto="";

    /**
     * Creates new form ConsultaFamilia
     */
    public ConsultaTpMovto() {
        initComponents();
    }
    ...
    private void jTConsultaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTConsultaMouseClicked
        ...
        retornaDsTpMovto = jTConsulta.getValueAt(linha, 1).toString();
    ...
    private void jBPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBPesquisarActionPerformed
        ...
        switch (jCbPesquisa2.getSelectedIndex()) {
            case 0: {
                tpMovtoDAO.consultasimples(tipoMovto);
                preencher.PreencherJtableGenerico(jTConsulta, tipoMovto.getRetorno());
                return;
            }
            case 1: {
                String DsCliente = jTFPesquisa.getText().toUpperCase();
                tpMovtoDAO.consultaDescSimples(tipoMovto);
                preencher.PreencherJtableGenerico(jTConsulta, tipoMovto.getRetorno());
                return;
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultaTpMovto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ConsultaTpMovto().setVisible(true);
            }
        });
    }
